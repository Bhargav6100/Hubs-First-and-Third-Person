...
import { POVPopoverContainer } from "./room/POVPopoverContainer";
...
class UIRoot extends Component {
  ...
  render() {
    ...
    const canCloseRoom = this.props.hubChannel && !!this.props.hubChannel.canOrWillIfCreator("update_hub");
              ...
              <RoomLayoutContainer
                        ...
                        <ContentMenu >
                          {showObjectList && (
                            <ObjectsMenuButton
                              ...
                              objectCount={this.state.objectCount}
                            />
                          )}
                          <PeopleMenuButton
                ...
                toolbarCenter={
                  <>
                    ...
                    <POVPopoverContainer onClick={this.enableThirdPersonView}/>
                    {entered && isMobileVR && (
                      <ToolbarButton
