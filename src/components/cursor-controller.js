    ...
    return function (t, left) {
      ...
      if (!isGrabbing) {
        ...
        if (remoteHoverTarget) {
          ...
          // this.el.object3D.addEventListener("click",function(){
          // console.log("click nahi ho raha")
          // this.el.setAttribute("single-action-button","event:click")
          // this.el.setAttribute("clickable","")
          //this.el.setAttribute("overwrite-raycast-as-noop","")
          // })
        }
        ...
        // const clickable=this.intersection && findRemoteHoverTarget(APP.world,this.intersection.object);
        // isHoveringSomething = !!clickable;
        // if(clickable){
        //   addComponent(APP.world,Clickable)
        //   console.log("hiii")
        // }
