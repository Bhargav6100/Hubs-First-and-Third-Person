...
AFRAME.GLTFModelPlus.registerComponent("super-spawner", "super-spawner", (el, componentName, componentData) => {
  ...
  el.setAttribute("single-action-button","");
...
//AFRAME.GLTFModelPlus.registerComponent("ammo-shape","clickable");
...
AFRAME.GLTFModelPlus.registerComponent("clickable","clickable");
